MapSongBanks::
	...
	db MUSIC_ROUTES2, BANK(Music_Routes2) ; BILLS_LIGHTHOUSE_1F
	db MUSIC_ROUTES2, BANK(Music_Routes2) ; BILLS_LIGHTHOUSE_2F
	db MUSIC_ROUTES2, BANK(Music_Routes2) ; BILLS_LIGHTHOUSE_3F
	db MUSIC_ROUTES2, BANK(Music_Routes2) ; BILLS_LIGHTHOUSE_4F
	...
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; CINN_VOL_1F
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; CINN_VOL_TF
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; CINN_VOL_BF
	...
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; CERULEAN_FOREST
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; LAVENDER_FOREST
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; CELADON_FOREST
	db MUSIC_DUNGEON2, BANK(Music_Dungeon2) ; VERMILION_FOREST
	db MUSIC_ROUTES2, BANK(Music_Routes2) ; BILLS_LIGHTHOUSE
